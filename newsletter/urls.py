...
from newsletter.views import (HomeView, MailingDetailView, MailingListCreateView, MailingListDeleteView,
                              MailingListToggleView, MailingListUpdateView, MailingListView, MailSend,
                              ...
                              RecipientUpdateView, StatisticView)
